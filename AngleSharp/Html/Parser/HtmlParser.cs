...
namespace AngleSharp.Html.Parser
{
    ...
    public class HtmlParser : EventTarget, IHtmlParser
    {
        ...
        /// Parses the string and returns the result.
        /// </summary>
        public IEnumerable<string> ParseDocumentCustom(String source)
        {
            var document = CreateDocument(source);
            return ParseCustom(document);
        }
        ...
        /// Parses the stream and returns the result.
        /// </summary>
        public IEnumerable<string> ParseDocumentCustom(Stream source)
        {
            var document = CreateDocument(source);
            return ParseCustom(document);
        }
        ...
        private IEnumerable<string> ParseCustom(HtmlDocument document, String? stopAt = null)
        {
            var parser = CreateBuilder(document, stopAt);
            return parser.ParseCustom(_options);
        }
